...
namespace RetoHemoglobina.Controllers
{
    ...
    public class PacientesController : ControllerBase
    {
        ...
        [HttpPost("procesar")]
        public async Task<IActionResult> ProcesarPacientes([FromBody] List<PacienteRequestDTO> pacientesRequest)
        {
            ...
            //try
            //{
            RespuestaGeneralDTO respuesta = await _pacienteService.ProcesarPacientesAsync(pacientesRequest);
            return Ok(respuesta);
            //}
        ...
        public async Task<IActionResult> ListarPacientes()
        {
            //try
            //{
            var respuesta = await _pacienteService.ListarPacientesAsync();
            return Ok(respuesta);
            //}
            //catch (InvalidOperationException ex)
            //{
        ...
        public async Task<IActionResult> ListarConsultasPorPaciente(int identificacion)
        {
            //try
            //{
            var respuesta = await _pacienteService.ListarConsultasPorPacienteAsync(identificacion);
            return Ok(respuesta);
            //    }
            //    catch (InvalidOperationException ex)
            //    {
        ...
        public async Task<IActionResult> ListarConsultas()
        {
            //try
            //{
            var respuesta = await _pacienteService.ListarConsultasAsync();
            return Ok(respuesta);
            //}
            //catch (InvalidOperationException ex)
            //{
